...
public class multimoo
{
	...
	public static HashMap<Integer, ArrayList<Integer>> nextRegions;
	...
	public static void main(String[] args) throws IOException
	{
		...
		for (int i = 0; i < regionNexts.size(); i++)
			max = Math.max(max, ff1(i, new boolean[regionNexts.size()], idOfRegion.get(i)));
		out.println(max);
		out.close();
		f.close();
	}
	...
	public static int ff1(int regioncount, boolean[] visited, int id1)
	{
		int count = 1;
		ArrayList<Integer> countofOtherRegions = new ArrayList<>();
